...
sub init { # Prontus 6.0
  ...
  $MSG_BLOQUEOSYSADMIN = 'Este Administrador de Contenidos se encuentra actualmente en mantenci�n, para mayor informaci�n comun�quese con el Webmaster.';
  ...
  # Portadas publicables en la edici�n base.
  @BASE_PORTS = ();
...
sub get_dir_server {
  ...
  #   En unix queda algo asi como /sites/misitio.cl/web
    ...
    if ((! -d $dir_server) || (!$dir_server)) {
        ...
        print 'Error, no se ha podido detectar DOCUMENT ROOT o �ste no es v�lido';
        exit;
    };
