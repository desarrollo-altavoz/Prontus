...
# -------------------------------COMENTARIO GLOBAL---------------
# Dispara importacion de Tags Prontus.
# ---------------------------------------------------------------
...
main: {
  ...
  if ($FORM{'Sbm_ACCION'} =~ /^Importar/i) {
    ...
    # print STDERR "FILE[$FORM{'FILE1'}][$prontus_varglb::DIR_SERVER$prontus_varglb::DIR_DBM/tags_import.xml]\n";

    &File::Copy::copy($FORM{'FILE1'}, "$prontus_varglb::DIR_SERVER$prontus_varglb::DIR_CPAN/procs/tags_import.xml");
    ...
    &lib_prontus::call_system_and_location($prontus_varglb::DIR_SERVER, 'prontus_tags_import_real', $result_page, $params);
