var tinymce_valid_elements = ""
  ...
  // +"body[class|dir<ltr?rtl|id|lang|onclick"
  ...
  +"em/i[class|dir<ltr?rtl|id|lang|onclick|ondblclick|onkeydown|onkeypress"
   ...
   // EMBED NO ES PARTE DEL STANDARD, PERO SE PONE PARA COMPATIBILIDAD GOOGLE Y YOUTUBE
  /*+"embed[align<bottom?left?middle?right?top|src|type|wmode|width"
    +"|height|id|style|name|flashvars|"
    +"|title],"
  */
  ...
  +"form[accept|accept-charset|action|class|dir<ltr?rtl|enctype|id|lang"
    +"|method<get?post|onclick|ondblclick|onkeydown|onkeypress|onkeyup"
  ...
  +"hr[class|dir<ltr?rtl|id|lang|onclick"
    +"|ondblclick|onkeydown|onkeypress|onkeyup|onmousedown|onmousemove"
    +"|onmouseout|onmouseover|onmouseup|style|title],"
  // +"html[dir<ltr?rtl|lang|version],"

  +"img[alt|class|dir<ltr?rtl|height"
    +"|id|ismap<ismap|lang|longdesc|onclick|ondblclick|onkeydown"
    +"|onkeypress|onkeyup|onmousedown|onmousemove|onmouseout|onmouseover"
  ...
  +"object[align<bottom?left?middle?right?top|archive|border|class|classid"
    ...
    +"|vspace|width],"
  +"ol[class|dir<ltr?rtl|id|lang|onclick|ondblclick|onkeydown"
    +"|onkeypress|onkeyup|onmousedown|onmousemove|onmouseout|onmouseover"
    +"|onmouseup|style|title],"
  ...
  +"table[border|cellpadding|cellspacing|class"
    ...
    +"|onkeyup|onmousedown|onmousemove|onmouseout|onmouseover|onmouseup|frame|rules"
  ...
  +"td[abbr|align<center?char?justify?left?right|axis|char|charoff|class"
    +"|colspan|dir<ltr?rtl|headers|id|lang|onclick"
    +"|ondblclick|onkeydown|onkeypress|onkeyup|onmousedown|onmousemove"
  ...
  +"tt[class|dir<ltr?rtl|id|lang|onclick|ondblclick|onkeydown|onkeypress|onkeyup"
    +"|onmousedown|onmousemove|onmouseout|onmouseover|onmouseup|style|title],"
  +"ul[class|dir<ltr?rtl|id|lang|onclick|ondblclick|onkeydown"
    +"|onkeypress|onkeyup|onmousedown|onmousemove|onmouseout|onmouseover"
    +"|onmouseup|style|title],"
