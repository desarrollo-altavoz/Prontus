	...
	******/
	...
	class Compressor{
		...
		//	$this->datas.= sprintf("editAreaLoader.iframe_script= \"<script type='text/javascript'>%s</script>\";\n", $sub_scripts);
            ...
            $mycss = $this->get_css_content("edit_area.css");
            $mycss = str_replace('#result .edit_area_cursor', '"+(((navigator.userAgent.indexOf(\'AppleWebKit\')!=-1)&&(navigator.userAgent.indexOf(\'Chrome\')==-1))?"#textarea {left:3px;}":"")+"#result .edit_area_cursor', $mycss);
