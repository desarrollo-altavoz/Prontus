...
# Servidor SMTP
# -------------
# El Formulario Prontus utiliza el servidor SMTP definido en la configuraci�n global
#
# Archivos temporales
# -------------------
...
# 2.0.1 13/01/2017 - EAG - Se agrega funci�n custom para el ordenamiento de campos
# To-Do:
...
sub data_management {
    ...
    # Solamente guarda archivos adjuntos si est� activa esta opci�n!
    ...
    foreach my $key (@DATOS) {
        ...
        utf8::decode($data);
        $data =~ s/[^\w\-��������������\, ]//g; # Elimina todo caracter extrano.
        utf8::encode($data);
        $subj =~ s/\%$key\%/$data/sg;
    };
